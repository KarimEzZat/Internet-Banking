...
if($option=='ATM')
    ...
    {
        echo '<script>alert("لقد تم التقديم في هذه الخدمه مسبقا");';
...
echo '<script>alert("تم الطلب ستصلك رساله التاكيد قريبا");window.location= "customer_issue_atm.php";</script>';
}
else {
