                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-md-9">
                        <form action="editstaff.php" method="POST">
                            <h3 class="text-center" style="margin-bottom: 20px">بيانات الموظفين</h3>
                            <table class="table" align="center" style="margin-bottom: 30px">
                            ...
                            <input type="submit" name="submit1_id" value="تعديل بيانات الموظف" class='btn' >
                        </form>
                    </div>
                </div>
